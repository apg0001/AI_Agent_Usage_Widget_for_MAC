...
const ko: Translations = {
  ...
  usage: {
    ...
    claudeWaitingRefresh: "저장된 Claude Code 로그인은 확인했지만 액세스 토큰 갱신을 기다리는 중입니다. 잠시 후 자동으로 다시 시도합니다.",
...
const en: Translations = {
  ...
  usage: {
    ...
    claudeWaitingRefresh: "Found a saved Claude Code sign-in, but it's waiting on an access token refresh. Retrying automatically shortly.",
